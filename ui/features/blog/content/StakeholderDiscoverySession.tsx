const StakeholderDiscoverySession: React.FC = () => {
  return (
    <div className="blog-wrap">
      ...
      <h3>Assume everything will change. Seriously, everything.</h3>
      <p>
      ...
      <h3>A POC is worth a thousand words in a meeting</h3>
      <p>
      ...
      <h3>Resource constraints are a business requirement, not an afterthought</h3>
      <p>
      ...
      <h3>The client's own team isn't always on the same page</h3>
      <p>
      ...
      <h3>The mindset shift that ties it all together</h3>
      <p>
