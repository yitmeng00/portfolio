...
interface LightboxProps {
  selectedImage: Omit<Photo, "id"> | null;
  isOpen: boolean;
  onClose: () => void;
}

const Lightbox = ({ selectedImage, isOpen, onClose }: LightboxProps) => {
  return (
    <div id="gallery-lightbox" className={isOpen ? "is-open" : "is-closed"} onClick={onClose}>
      {selectedImage && (
