  ...
  return (
    <section className="about__container">
      <p className="about__paragraph-item">
        ...
        has been my passion forever. For me, the best part of being an architect and engineer is
        being able to craft solutions that actually make a difference. Whether it’s building a
        solution that solves a real-life problem or developing a feature that improves user
        experience, it’s all about using tech as a modern-day magic wand to make life easier, more
