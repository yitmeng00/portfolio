            ...
            <div className="relative">
                ...
                <div className="xl:px-40 lg:px-32 px-10 py-10">
                    <div className="flex flex-col items-center mb-8">
                        <img
                            src="/portfolio/assets/project/arkhalal.png"
                            alt="ARK Halal"
                            className="size-3/4"
                        />
                        <NavLink to={"https://www.arkhalal.com/"}>
                    ...
                    <div className="mb-8">
                        ...
                        <div className="flex flex-col gap-5 text-justify">
                            <h6>
                                ARK Halal is a company with HALAL Competency
                                Development Specialists that provide halal
                                solutions to food establishments, processing
                                plants, ingredients suppliers, as well as
                                importers, exporters, and abattoirs.
                            </h6>
                            <h6>
