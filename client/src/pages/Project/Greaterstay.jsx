            ...
            <div className="relative">
                ...
                <div className="xl:px-40 lg:px-32 px-10 py-10">
                    <div className="flex flex-col items-center mb-8">
                        <img
                            src="/portfolio/assets/project/greaterstay.png"
                            alt="Greater Stay"
                            className="size-3/4"
                        />
                        <NavLink to={"https://greaterstay.com/"}>
                    ...
                    <div className="mb-8">
                        ...
                        <div className="flex flex-col gap-5 text-justify">
                            <h6>
                                Greater Stay is a hotel booking company offering
                                services for Est. Bangsar and J.Dupion Boutique
                                Suites.
                            </h6>
                            <h6>
