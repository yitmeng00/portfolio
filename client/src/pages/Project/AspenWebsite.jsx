        ...
        <>
            ...
            <div className="relative">
                <div className="bg-primary-200 px-10 py-24 text-center sm:text-7xl text-5xl text-primary-600 font-bold">
                    <p>Aspen Spectra Official Website</p>
                </div>
                <div className="xl:px-40 lg:px-32 px-10 py-10">
                    <div className="flex flex-col items-center mb-8">
                        <img
                            src="/portfolio/assets/project/aspen-website.png"
                            alt="Aspen Spectra Website"
                            className="size-3/4"
                        />
                        <NavLink to={"https://aspen-spectra.com/"}>
                    ...
                    <div className="mb-8">
                        ...
                        <div className="flex flex-col gap-5 text-justify">
                            <h6>
                                As a lead full-stack developer for this project,
                                I led the development of my company's official
                                website, a pivotal project that encapsulated my
                                company brand ethos and offerings.
                            </h6>
                            <h6>
                                My responsibilities included customizing and
                                developing the WordPress theme, managing web
